...
echo ""
echo "==> Important production step:"
echo "    In the Tailscale admin dashboard, open this device and disable key expiry."
echo "    Otherwise Tailscale may require re-authentication later and remote access can stop."
echo ""
